...
class AudioUtils:
    ...
    def validate_audio_file(self, audio_data: bytes) -> bool:
        ...
        try:
            ...
            # For other formats, assume valid if not empty
            return True
    ...
    def estimate_duration(self, audio_data: bytes, sample_rate: int = 16000) -> float:
        ...
        try:
            ...
            # For compressed formats, this won't be accurate
            if len(audio_data) < 44:  # Minimum for WAV header
                return 0.0
            
            # Rough calculation assuming 16-bit stereo
            bytes_per_sample = 2
            channels = 2
    ...
    def create_audio_player_html(self, audio_data: bytes, autoplay: bool = False) -> str:
        ...
        try:
            ...
            return "<p>Error loading audio player</p>"
